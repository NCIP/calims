 ...
 *
 */
public class QueryControllerSubFlowTest extends SubFlowReturnTester<QueryController> {
  /**
   * Constructor.
   * 
   ...
   */
  public QueryControllerSubFlowTest(int subFlowId, boolean collection, String propertyName) {
  ...
  public static Collection<? extends Object> data() {
    Object[][] data = new Object[][] {{QueryController.TYPE_SUBFLOW_ID, false, "type" }};
