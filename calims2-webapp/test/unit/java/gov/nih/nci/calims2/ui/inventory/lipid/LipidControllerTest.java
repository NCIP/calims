 ...
 * 
 */
public class LipidControllerTest {
  /**
   * Test the controller constructor.
   */
  @Test
  public void testConstructor() {
    LipidController controller = new LipidController();
    CRUDAssert.assertControllerConstructor(controller, LipidController.URL_PREFIX, "inventory.lipid.", "name", Lipid.class,
        LipidForm.class, CRUDTableDecorator.class);
  }
  ...
  public void testCompleteEditModel() {
    ...
    CRUDAssert.assertTypes(typeService, TypeEnumeration.LIPID, "types", result);
