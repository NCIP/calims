 ...
 * 
 */
public class ContainerSubcategoryControllerTest {
  /**
   * Test the controller constructor.
   */
  @Test
  public void testConstructor() {
    ContainerSubcategoryController controller = new ContainerSubcategoryController();
    CRUDAssert.assertControllerConstructor(controller, ContainerSubcategoryController.URL_PREFIX,
        "inventory.containersubcategory.", "name", ContainerSubcategory.class, ContainerSubcategoryForm.class,
  ...
  public void testCompleteEditModel() {
    ...
    CRUDAssert.assertTypes(typeService, TypeEnumeration.CONTAINER, "types", result);
  }
