 ...
 *
 */
public class AccountNumberControllerSubFlowTest extends SubFlowReturnTester<AccountNumberController> {
   ...
   */
  public AccountNumberControllerSubFlowTest(int subFlowId, boolean collection, String propertyName) {
  ...
  public static Collection<? extends Object> data() {
    Object[][] data = new Object[][] {{AccountNumberController.TYPE_SUBFLOW_ID, false, "type" }};
