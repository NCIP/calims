...
public class AntibodyFormTest {
  ...
  public void testGetSubmittedEntity() {
    ...
    form.setAntigenId(1L);
    form.setPersonId(1L);
    CRUDFormTestHelper.setNotes(form);
    Antibody entity = form.getSubmittedEntity();
    assertNotNull("No submitted Entity", entity);
    CRUDFormAssert.assertEntity(Antigen.class, entity.getAntigen(), 1L);
