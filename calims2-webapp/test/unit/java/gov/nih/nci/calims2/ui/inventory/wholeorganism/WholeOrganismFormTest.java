 ...
 *
 */
public class WholeOrganismFormTest {
  ...
  public void testGetSubmittedEntity() {
    ...
    form.setAdditionalOrganismNameIds(IDS);
    ...
    WholeOrganism entity = form.getSubmittedEntity();
    ...
    CRUDFormAssert.assertEntities(AdditionalOrganismName.class, entity.getAdditionalOrganismNameCollection(), IDS);
