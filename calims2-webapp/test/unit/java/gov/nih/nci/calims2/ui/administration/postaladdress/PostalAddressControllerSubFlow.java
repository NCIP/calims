 ...
 *
 */
public class PostalAddressControllerSubFlow extends SubFlowReturnTester<PostalAddressController> {
   ...
   */
  public PostalAddressControllerSubFlow(int subFlowId, boolean collection, String propertyName) {
  ...
  public static Collection<? extends Object> data() {
    Object[][] data = new Object[][] {{PostalAddressController.TYPE_SUBFLOW_ID, false, "type" }};
