 ...
 *
 */
public class ContainerSubcategorySubFlowTest extends SubFlowReturnTester<ContainerSubcategoryController> {
   ...
   */
  public ContainerSubcategorySubFlowTest(int subFlowId, boolean collection, String propertyName) {
  ...
  public static Collection<? extends Object> data() {
    Object[][] data = new Object[][] {
        {ContainerSubcategoryController.TYPE_SUBFLOW_ID, false, "type" }};
