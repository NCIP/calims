...
<body id="bodyId" class="${dojoAccess} ${dojoTheme}">
  <div class="pageWithMenuContainer" dojoType="dijit.layout.LayoutContainer">
    <div class="headerPane" dojoType="dijit.layout.ContentPane" layoutAlign="top">
      <tiles:insertAttribute name="header" />
    </div>
    <div class="pageWithMenuMenu" dojoType="dijit.layout.ContentPane" layoutAlign="top">
      <tiles:insertAttribute name="menu" />
    </div>
    <div class="pageWithMenuBody" dojoType="dijit.layout.ContentPane" layoutAlign="client">
