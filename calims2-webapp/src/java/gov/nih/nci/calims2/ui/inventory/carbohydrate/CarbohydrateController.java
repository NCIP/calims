 ...
 */
@Controller
@RequestMapping(CarbohydrateController.URL_PREFIX)
public class CarbohydrateController extends CRUDController<Carbohydrate> {

  /** Prefix of urls of this module. */
  static final String URL_PREFIX = "/inventory/carbohydrate";
   ...
   * Default constructor.
   */
  public CarbohydrateController() {
    super(URL_PREFIX, "name");
    CRUDControllerConfig config = getConfig();
    config.setSubFlowUrls(new String[] {"/common/type/create.do?dataElementCollection=" + TypeEnumeration.CARBOHYDRATE,
                                        "/inventory/taxon/create.do", 
                                        "/administration/organization/create.do", 
                                        "/administration/location/create.do",
                                        "/inventory/carbohydrate/create.do", 
  ...
  void addCategories(ModelAndView model) {
    Carbohydrate specimen = ((CarbohydrateForm) model.getModel().get("form")).getEntity();
  ...
  public ModelAndView completeEditModel(ModelAndView model, Locale locale) {
    ...
    CarbohydrateForm form = (CarbohydrateForm) model.getModel().get("form");
    ...
    Specimen specimen = ((CarbohydrateForm) model.getModel().get("form")).getEntity();
    ...
    params = new HashMap<String, Object>();
    params.put("dataElementCollection", TypeEnumeration.CARBOHYDRATE.name());
  ...
  void addQuantities(ModelAndView model, boolean createMissing) {
    Set<Quantity> quantities = ((CarbohydrateForm) model.getModel().get("form")).getEntity().getQuantityCollection();
  ...
  public ModelAndView call(@ModelAttribute("form") CarbohydrateForm form, @RequestParam("subFlowId") int subFlowId) {
  ...
  public void doReturnFromFlow(ModelAndView model, int subFlowId, Long entityId) {
    if (entityId != null) {
      Carbohydrate carbohydrate = ((CarbohydrateForm) model.getModel().get("form")).getEntity();
      switch (subFlowId) {
        case TAXON_SUBFLOW_ID: {
          carbohydrate.setTaxon(EntityWithIdHelper.createEntity(Taxon.class, entityId));
          break;
        }
        case ORGANIZATION_SUBFLOW_ID: {
          carbohydrate.getOrganizationCollection().add(EntityWithIdHelper.createEntity(Organization.class, entityId));
          break;
        }
        case LOCATION_SUBFLOW_ID: {
          carbohydrate.getSamplingLocationCollection().add(EntityWithIdHelper.createEntity(Location.class, entityId));
          break;
        }
        case TYPE_SUBFLOW_ID: {
          carbohydrate.setType(EntityWithIdHelper.createEntity(Type.class, entityId));
          break;
        }
        case SPECIMEN_SUBFLOW_ID: {
          carbohydrate.setParentSpecimen(EntityWithIdHelper.createEntity(Specimen.class, entityId));
          break;
        }
        case CONTAINER_SUBFLOW_ID: {
          carbohydrate.setContainer(EntityWithIdHelper.createEntity(Container.class, entityId));
          break;
        }
        case PERSON_SUBFLOW_ID: {
          carbohydrate.setContactPerson(EntityWithIdHelper.createEntity(Person.class, entityId));
          break;
        }
  ...
  public ModelAndView save(@ModelAttribute("form") CarbohydrateForm form, Locale locale) {
    ...
    if (container.getContainerType().getComposition() == ContainerComposition.COMPOSITE) {
      ...
      Carbohydrate input = form.getSubmittedEntity();
      try {
  ...
  public void setSpecimenService(GenericService<Carbohydrate> specimenService) {
   ...
   */
  @Resource(name = "carbohydrateFormDecorator")
   ...
   */
  @Resource(name = "carbohydrateTable")
