 ...
 *
 */
public class NanomaterialForm extends CRUDForm<Nanomaterial> {
  ...
  private Long chemicalCompoundId;
   ...
   * Default constructor.
   */
  public NanomaterialForm() {
    setEntity(new Nanomaterial());
  }
  ...
  public Nanomaterial getSubmittedEntity() {
    Nanomaterial nanomaterial = getEntity();
    ...
    if (persistentClass == ServiceItem.class) {
      nanomaterial.setServiceItem(EntityWithIdHelper.createEntity(ServiceItem.class, id));
    }
    nanomaterial.setChemicalCompound(EntityWithIdHelper.createEntity(ChemicalCompound.class, chemicalCompoundId));
    nanomaterial.setContactPerson(EntityWithIdHelper.createEntity(Person.class, personId));
    nanomaterial.setContainer(EntityWithIdHelper.createEntity(Container.class, containerId));
    nanomaterial.setExternalIdentifierCollection(EntityWithIdHelper.createEntities(ExternalIdentifier.class, 
        externalIdentifierIds));
    nanomaterial.setIsAvailable(checkBoolean(nanomaterial.getIsAvailable()));
    nanomaterial.setNotesCollection(getNotesCollection());
    nanomaterial.setOrganizationCollection(EntityWithIdHelper.createEntities(Organization.class, organizationIds));
    nanomaterial.setParentSpecimen(EntityWithIdHelper.createEntity(Specimen.class, specimenId));
    nanomaterial.setQuantityCollection(quantities.getQuantities());
    nanomaterial.setSamplingLocationCollection(EntityWithIdHelper.createEntities(Location.class, locationIds));
    return nanomaterial;
  }
  ...
  /**
   * @return the chemicalCompoundId
   */
  public Long getChemicalCompoundId() {
    return chemicalCompoundId;
  }

  /**
   * @param chemicalCompoundId the chemicalCompoundId to set
   */
  public void setChemicalCompoundId(Long chemicalCompoundId) {
    this.chemicalCompoundId = chemicalCompoundId;
  }
