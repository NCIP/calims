 ...
 *
 */
package gov.nih.nci.calims2.business.administration.customerservice.serviceitem;
 ...
 *
 */
public class ServiceItemValidatorMockup implements Validator {
  private ServiceItem testEntity;

  /**
   * @return testEntity The entity to return.
   */
  public ServiceItem getEntity() {
    return testEntity;
  }
   ...
   * {@inheritDoc}
   */
  public <T> T unwrap(Class<T> inquiry) {
