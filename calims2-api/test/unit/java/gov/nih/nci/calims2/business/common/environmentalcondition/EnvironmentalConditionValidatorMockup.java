 ...
 *
 */
public class EnvironmentalConditionValidatorMockup implements Validator {

  private EnvironmentalCondition testEntity;

  /**
   * @return testEntity The entity to return.
   */
  public EnvironmentalCondition getEntity() {
    return testEntity;
  }
  ...
  public <T> Set<ConstraintViolation<T>> validate(T object, Class<?>... groups) {
    testEntity = (EnvironmentalCondition) object;
