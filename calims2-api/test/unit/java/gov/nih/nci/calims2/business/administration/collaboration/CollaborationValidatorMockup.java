 ...
 *
 */
public class CollaborationValidatorMockup implements Validator {

  private Collaboration testEntity;

  /**
   * @return testEntity The entity to return.
   */
  public Collaboration getEntity() {
    return testEntity;
  }
  ...
  public <T> Set<ConstraintViolation<T>> validate(T object, Class<?>... groups) {
    testEntity = (Collaboration) object;
