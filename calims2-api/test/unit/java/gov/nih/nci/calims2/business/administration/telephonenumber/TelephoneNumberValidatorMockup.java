 ...
 *
 */
public class TelephoneNumberValidatorMockup implements Validator {
  private TelephoneNumber testEntity;

  /**
   * @return testEntity The entity to return.
   */
  public TelephoneNumber getEntity() {
    return testEntity;
  }
   ...
   * {@inheritDoc}
   */
  public <T> T unwrap(Class<T> telephoneNumber) {
  ...
  public <T> Set<ConstraintViolation<T>> validate(T object, Class<?>... groups) {
    testEntity = (TelephoneNumber) object;
