 ...
 *
 */
public class AdditionalOrganismNameValidatorMockup implements Validator {

  private AdditionalOrganismName testEntity;

  /**
   * @return testEntity The entity to return.
   */
  public AdditionalOrganismName getEntity() {
    return testEntity;
  }
  ...
  public <T> Set<ConstraintViolation<T>> validate(T object, Class<?>... groups) {
    testEntity = (AdditionalOrganismName) object;
