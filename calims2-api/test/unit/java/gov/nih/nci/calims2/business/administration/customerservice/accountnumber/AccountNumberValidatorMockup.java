 ...
 *
 */
public class AccountNumberValidatorMockup implements Validator {
  private AccountNumber testEntity;

  /**
   * @return testEntity The entity to return.
   */
  public AccountNumber getEntity() {
    return testEntity;
  }
   ...
   * {@inheritDoc}
   */
  public <T> T unwrap(Class<T> equipment) {
  ...
  public <T> Set<ConstraintViolation<T>> validate(T object, Class<?>... groups) {
    testEntity = (AccountNumber) object;
