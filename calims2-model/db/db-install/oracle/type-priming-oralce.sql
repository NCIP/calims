...
INSERT INTO type (id, createdby, datecreated, datemodified, modifiedby, description, displayname, name, dataelementcollection, status) VALUES (8003, NULL, NULL, NULL, NULL, 'Quantity', 'Quantity', 'Quantity ', 'RATE_QUANTITY', 'CURRENT');
INSERT INTO type (id, createdby, datecreated, datemodified, modifiedby, description, displayname, name, dataelementcollection, status) VALUES (8002, NULL, NULL, NULL, NULL, 'Quantity', 'Quantity', 'Quantity ', 'SERVICEITEM_QUANTITY', 'CURRENT');
INSERT INTO type (id, createdby, datecreated, datemodified, modifiedby, description, displayname, name, dataelementcollection, status) VALUES (8001, NULL, NULL, NULL, NULL, 'Quantity', 'Quantity', 'Quantity ', 'QUOTATION_QUANTITY', 'CURRENT');
