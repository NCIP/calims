...
@Entity
@Table(name = "SMALLMOLECULE")
@PrimaryKeyJoinColumn(name = "ID")
@org.hibernate.annotations.ForeignKey(name = "FK_SMALLMOLECULE_MOLECULARSP")

public class SmallMolecule extends MolecularSpecimen {
/**
...
**/
  ...
  /**
* Retrieves the value of the mechanismOfAction attribute.
* @return mechanismOfAction
**/
  
  @Column(name = "MECHANISMOFACTION", length = EntityWithId.COLUMNLENGTH)
  ...
  /**
* Sets the value of mechanismOfAction attribute.
* @param mechanismOfAction .
**/
  public void setMechanismOfAction(String 
  mechanismOfAction) {
 ...
 **/ public void accept(SpecimenVisitor specimenVisitor) {
       specimenVisitor.visitSmallMolecule(this);
}
