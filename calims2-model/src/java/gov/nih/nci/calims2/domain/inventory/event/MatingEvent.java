...
@Entity
@DiscriminatorValue("MatingEvent")

public class MatingEvent extends Event {
/**
...
@org.hibernate.annotations.ForeignKey(name = "EVENTCORGANI_FK")
 ...
 **/ public void accept(EventVisitor eventVisitor) {
       eventVisitor.visitMatingEvent(this);
}
