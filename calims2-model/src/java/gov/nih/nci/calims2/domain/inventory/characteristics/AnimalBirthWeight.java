...
@Entity
@Table(name = "ANIMALBIRTHWEIGHT")
@PrimaryKeyJoinColumn(name = "ID")
@org.hibernate.annotations.ForeignKey(name = "FK_ANIMALBIRTHWEIGHT_QUANTIT")

public class AnimalBirthWeight extends QuantitativeBiocharacteristics {
/**
 ...
 **/ public void accept(CharacteristicsVisitor characteristicsVisitor) {
       characteristicsVisitor.visitAnimalBirthWeight(this);
}
