...
@Entity
@Table(name = "FILEEXTENSIONREFERENCE")
@PrimaryKeyJoinColumn(name = "ID")
@org.hibernate.annotations.ForeignKey(name = "FK_FILEEXTENSIONREFERENCE_EQ")

public class FileExtensionReference extends EquipmentIOType {
/**
...
@org.hibernate.annotations.ForeignKey(name = "FILEEXFILEEX_FK")
