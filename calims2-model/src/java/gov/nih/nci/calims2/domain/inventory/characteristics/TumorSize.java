...
@Entity
@Table(name = "TUMORSIZE")
@PrimaryKeyJoinColumn(name = "ID")
@org.hibernate.annotations.ForeignKey(name = "FK_TUMORSIZE_QUANTITATIVEBIO")

public class TumorSize extends QuantitativeBiocharacteristics {
/**
 ...
 **/ public void accept(CharacteristicsVisitor characteristicsVisitor) {
       characteristicsVisitor.visitTumorSize(this);
}
