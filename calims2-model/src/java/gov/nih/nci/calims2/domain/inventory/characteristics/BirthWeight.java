...
@Entity
@Table(name = "BIRTHWEIGHT")
@PrimaryKeyJoinColumn(name = "ID")
@org.hibernate.annotations.ForeignKey(name = "FK_BIRTHWEIGHT_QUANTITATIVEB")

public class BirthWeight extends QuantitativeBiocharacteristics {
/**
 ...
 **/ public void accept(CharacteristicsVisitor characteristicsVisitor) {
       characteristicsVisitor.visitBirthWeight(this);
}
