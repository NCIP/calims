...
public enum RunStatus  implements I18nEnumeration {
...
REVIEWED;
  ...
  public String getLocalizedValue(Locale locale) {
    return I18nEnumerationHelper.getLocalizedValue(gov.nih.nci.calims2.domain.workflow.l10n.RunStatusBundle.class, locale, this);
  }
