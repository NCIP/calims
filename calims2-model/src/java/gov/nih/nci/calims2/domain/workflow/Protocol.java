...
public class Protocol extends DisplayableEntity {
/**
...
* 
**/
  private gov.nih.nci.calims2.domain.workflow.enumeration.ProtocolStatus status;
  /**
...
**/
  ...
  public gov.nih.nci.calims2.domain.workflow.enumeration.ProtocolStatus getStatus() {
  return status;
  }
  /**
...
* @param status .
**/
  public void setStatus(gov.nih.nci.calims2.domain.workflow.enumeration.ProtocolStatus 
  status) {
  this.status = status;
  }
  /**
