...
@Entity
@Table(name = "NANOMATERIAL")
@PrimaryKeyJoinColumn(name = "ID")
@org.hibernate.annotations.ForeignKey(name = "FK_NANOMATERIAL_ARTIFICIALSP")

public class Nanomaterial extends ArtificialSpecimen {
/**
...
@org.hibernate.annotations.ForeignKey(name = "NANOMATERIAL_CHEMICALCOM_FK")
 ...
 **/ public void accept(SpecimenVisitor specimenVisitor) {
       specimenVisitor.visitNanomaterial(this);
}
