...
@Entity
@DiscriminatorValue("NeonatalHearingImpairment")

public class NeonatalHearingImpairment extends BioCharacteristics {
/**
 ...
 **/ public void accept(CharacteristicsVisitor characteristicsVisitor) {
       characteristicsVisitor.visitNeonatalHearingImpairment(this);
}
