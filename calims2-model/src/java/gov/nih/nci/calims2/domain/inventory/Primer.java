...
/**
* NCI|Short DNA oligonucleotide chains used to prime DNA (and in some cases RNA) synthesis.
**/

@Entity
@Table(name = "PRIMER")
@PrimaryKeyJoinColumn(name = "ID")
@org.hibernate.annotations.ForeignKey(name = "FK_PRIMER_NUCLEICACID")

public class Primer extends NucleicAcid {
/**
 ...
 **/ public void accept(SpecimenVisitor specimenVisitor) {
       specimenVisitor.visitPrimer(this);
}
