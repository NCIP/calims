...
@Entity
@DiscriminatorValue("BioCharacteristics")

public class BioCharacteristics extends Characteristics {
/**
...
@org.hibernate.annotations.ForeignKey(name = "BIOCHAANTIGEN_FK")
 ...
 **/ public void accept(CharacteristicsVisitor characteristicsVisitor) {
       characteristicsVisitor.visitBioCharacteristics(this);
}
