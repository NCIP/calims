...
@org.hibernate.annotations.ForeignKey(name = "FK_TREATMENT_QUANTITATIVEBIO")

public class Treatment extends QuantitativeBiocharacteristics {
/**
 ...
 **/ public void accept(CharacteristicsVisitor characteristicsVisitor) {
       characteristicsVisitor.visitTreatment(this);
}
