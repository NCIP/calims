...
@Entity
@Table(name = "ARTIFICIALSPECIMEN")
@PrimaryKeyJoinColumn(name = "ID")
@org.hibernate.annotations.ForeignKey(name = "FK_ARTIFICIALSPECIMEN_SPECIM")

public class ArtificialSpecimen extends Specimen {
/**
 ...
 **/ public void accept(SpecimenVisitor specimenVisitor) {
       specimenVisitor.visitArtificialSpecimen(this);
}
