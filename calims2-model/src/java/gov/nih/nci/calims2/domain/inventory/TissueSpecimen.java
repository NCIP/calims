...
/**
* NCI|An anatomical structure consisting of similarly specialized cells and intercellular matrix, aggregated
* according to genetically determined spatial relationships, performing a specific function.;NCI|A part
* of a thing, or of several things, taken to demonstrate or to determine the character of the whole,
* e.g. a substance, or portion of material obtained for use in testing, examination, or study; particularly,
* a preparation of tissue or bodily fluid taken for examination or diagnosis.
**/

@Entity
@Table(name = "TISSUESPECIMEN")
@PrimaryKeyJoinColumn(name = "ID")
@org.hibernate.annotations.ForeignKey(name = "FK_TISSUESPECIMEN_BIOSPECIME")

public class TissueSpecimen extends BioSpecimen {
/**
 ...
 **/ public void accept(SpecimenVisitor specimenVisitor) {
       specimenVisitor.visitTissueSpecimen(this);
}
