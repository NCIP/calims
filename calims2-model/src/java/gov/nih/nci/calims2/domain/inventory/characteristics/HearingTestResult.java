...
@Entity
@Table(name = "HEARINGTESTRESULT")
@PrimaryKeyJoinColumn(name = "ID")
@org.hibernate.annotations.ForeignKey(name = "FK_HEARINGTESTRESULT_QUANTIT")

public class HearingTestResult extends QuantitativeBiocharacteristics {
/**
 ...
 **/ public void accept(CharacteristicsVisitor characteristicsVisitor) {
       characteristicsVisitor.visitHearingTestResult(this);
}
