...
@Entity
@DiscriminatorValue("UltravioletExposure")

public class UltravioletExposure extends EnvironmentalCondition {
/**
 ...
 **/ public void accept(EnvironmentalConditionVisitor environmentalConditionVisitor) {
       environmentalConditionVisitor.visitUltravioletExposure(this);
}
