...
public class BillingInformation extends DisplayableEntity implements  EntityWithNotes {
/**
...
@org.hibernate.annotations.Type(type = "org.joda.time.contrib.hibernate.PersistentDateTime")
  ...
  /**
* Sets the value of date attribute.
* @param date .
**/
...
* 
**/
  private gov.nih.nci.calims2.domain.administration.customerservice.enumeration.BillingInformationStatus status;
  /**
...
**/
        ...
        @JoinTable(name="NOTES_BILLINGINFORMATION",joinColumns=@JoinColumn(name="ID_NOTES_BILLINGINFORMATI"))
        @ForeignKey(name="FK_NOTES_BILLINGINFORMATI")
