...
@Entity
@DiscriminatorValue("BehavioralCharacteristics")

public class BehavioralCharacteristics extends BioCharacteristics {
/**
 ...
 **/ public void accept(CharacteristicsVisitor characteristicsVisitor) {
       characteristicsVisitor.visitBehavioralCharacteristics(this);
}
